		...
		<>
			<div className={`SectionEventListImg secSpacing`}>
				<div className="banner relative mb-[120px] mb:mb-[80px]">
					<img src="/images/event/banner.jpg" alt="" className="aspect-[144/60] object-cover mb:aspect-[375/450]" />
				...
				<div className="cusContainer">
					<h2 className="mb-[60px] text-center text-[36px] font-bold uppercase mb:text-[20px]">square golf favorites</h2>
